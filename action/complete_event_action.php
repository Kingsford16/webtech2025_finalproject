...
// Update booking: set rm_id and change pro_id from 2 to 1 (completed)
$sql = "UPDATE bookings SET rm_id = ?, pro_id = 1 WHERE booking_id = ? AND app_id = 1";
$stmt = $conn->prepare($sql);
...
if ($stmt->execute()) {
    ...
    echo json_encode([
        'success' => true, 
        'message' => "Check event by $student_email as completed",
