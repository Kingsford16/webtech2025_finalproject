...
function display_all_resources_assigned_to_each_manager() {
    $resources = get_all_resources_assigned_to_each_manager();
...
<div class="ml-64 px-8 py-6 sidebar-expanded transition-all">
    ...
    <div class="bg-gray-200 p-4 rounded-md shadow-md max-w-md">
        <h3 class="text-lg font-bold mb-2">Personal Details</h3>
        <p><span class="font-semibold">Name:</span> <?= htmlspecialchars($USER_FULL_NAME) ?></p>
        <p><span class="font-semibold">Email:</span> <?= htmlspecialchars($USER_EMAIL) ?></p>
        <p><span class="font-semibold">Phone:</span> <?= htmlspecialchars($USER_PHONE) ?></p>
    </div>
    ...
    <div class="flex justify-center">
        <div class="bg-gray-900 text-white font-bold px-8 py-4 rounded-md shadow-md text-center">
            Area(s) Assigned to (<?= htmlspecialchars($USER_FULL_NAME) ?>)
        </div>
    </div>
    ...
    <div class="overflow-x-auto shadow-lg pb-20">
        ...
        <table class="w-full border-collapse">
            ...
            <tbody class="bg-white text-black">
                <?php display_all_resources_assigned_to_each_manager(); ?>
            </tbody>
        </table>
    </div>
