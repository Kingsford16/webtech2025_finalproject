...
<div class="flex justify-center relative">
    ...
    <nav class="flex flex-col space-y-4 mt-10 px-2">
        ...
        <a href="student_dashboard.php" 
            ...
            hover:bg-gray-700 <?php echo basename($_SERVER['PHP_SELF'])=='student_dashboard.php'?'bg-gray-800':''; ?>">
        ...
        <a href="book.php" 
            class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-md transition
            hover:bg-gray-700 <?php echo basename($_SERVER['PHP_SELF'])=='book.php'?'bg-gray-800':''; ?>">
