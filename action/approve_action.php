...
// Update booking: set rm_id and change app_id from 2 to 1 (approved)
$sql = "UPDATE bookings SET rm_id = ?, app_id = 1 WHERE booking_id = ? AND app_id = 2";
$stmt = $conn->prepare($sql);
...
if ($stmt->execute()) {
    ...
    echo json_encode([
        'success' => true, 
        'message' => "Request by $student_email is approved",
