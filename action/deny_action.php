...
// Update booking: set rm_id and change app_id from 2 to 3 (denied)
$sql = "UPDATE Bookings SET rm_id = ?, app_id = 3 WHERE booking_id = ? AND app_id = 2";
$stmt = $conn->prepare($sql);
...
if ($stmt->execute()) {
    ...
    echo json_encode([
        'success' => true, 
        'message' => "Request by $student_email is denied",
