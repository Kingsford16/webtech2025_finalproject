...
echo in_array(basename($_SERVER['PHP_SELF']), $dashboardPages)
     ? 'bg-gray-800' 
     : '';
?>
">
        ...
        <a href="resources.php" 
            class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-md transition
            hover:bg-gray-700 <?php echo basename($_SERVER['PHP_SELF'])=='resources.php'?'bg-gray-800':''; ?>">
        ...
        <a href="resource_managers.php" 
            class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-md transition
            hover:bg-gray-700 <?php echo basename($_SERVER['PHP_SELF'])=='resource_managers.php'?'bg-gray-800':''; ?>">
